...
/*  gtk_window_set_position (GTK_WINDOW (gAutoClick), GTK_WIN_POS_CENTER); */
  ...
  predelay_spin_adj = gtk_adjustment_new (PREDELAY_DEFAULT, PREDELAY_MIN, PREDELAY_MAX, 1, 10, 10);
  ...
  interval_spin_adj = gtk_adjustment_new (INTERVAL_DEFAULT, INTERVAL_MIN, INTERVAL_MAX, 1, 10, 10);
  ...
  random_spin_adj = gtk_adjustment_new (RANDOM_FACTOR_DEFAULT, RANDOM_FACTOR_MIN, RANDOM_FACTOR_MAX, 1, 10, 10);
  ...
  nrofclicks_spin_adj = gtk_adjustment_new (NUM_CLICKS_DEFAULT, NUM_CLICKS_MIN, NUM_CLICKS_MAX, 1, 10, 10);
